...
import toothimg from '../assets/images/dental_logo.jpg';
...
export default function Testimonial() {
    ...
    return (
        <>
            <div className="mb-12 md:mb-0 p-12 border border-gray-300 rounded-lg" data-aos="flip-left">
                <div className="flex justify-center mb-6">
                    <img src={toothimg} className="rounded shadow-lg w-32 h-32" alt="image slide 1"/>
                </div>
